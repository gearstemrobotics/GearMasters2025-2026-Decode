...
@Autonomous
public class ADumpsGateAutoBlue extends baseAuto {
    ...
    protected void RunOpModeInnerLoop() {
        ...
        Action shootBalls2 = drive.actionBuilder(firstBallsBlue)
        ...
        Action collectBalls1 = drive.actionBuilder(beginPose)
                ...
                .strafeTo(new Vector2d(9, -53))
                .build();

        Action shootBalls1 = drive.actionBuilder(secondBallsBlue)
                // goes back to the goal to shoot
                .strafeTo(new Vector2d(12.3, -24))
                .splineToSplineHeading(beginPose,280.7)
                .build();
